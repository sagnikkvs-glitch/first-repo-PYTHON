...
# Tk() creates the main window.     bilds the base on whivh the other widgets are built.
# mainloop() keeps the window running.

# star here in the next line says that we can import everythhing i.e. BRING ME THE FULL TOOL BOX
